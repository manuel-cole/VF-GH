                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="user-list">
                                ...
                                <tbody>
                                <?php foreach ($ceo_pending as $ceo_pending) : ?>
                                    <?php if (!empty($ceo_pending)) :
                                        $_counter = $_counter + 1;
                                        $id = $ceo_pending['auto_id'];
                                        ?>
                                        <tr>
                                            <td class="user-cell" style="width:20px"><?php echo $_counter; ?></td>
                                            <td class="user-cell"
                                                style="width:180px"><?php echo getEmployeeName($ceo_pending['emp_id']); ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $ceo_pending['submitted_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $ceo_pending['cost_centre']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $ceo_pending['destination']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $ceo_pending['departure_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $ceo_pending['arrival']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo getTravelType($ceo_pending['request_type']); ?></td>
