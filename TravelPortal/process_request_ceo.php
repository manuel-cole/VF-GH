    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            if (isset($_POST['btnSubmit'])) {
                submitCEOApproval($reqid);
            }
            if (isset($_POST['btnReject'])) {
                submitCEORejection($reqid);
            }
            ?>
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <form role="form" name="createuser" action="" method="post">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group input-group">
                                        ...
                                        <input type="text" class="form-control" id="transportation"
                                               name="transportation" value="<?php echo $rs[0]['transportation']; ?>"
                                               readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">SMT Approval</span>
                                        <input type="text" class="form-control" id="date_spend" name="date_spend"
                                               value="<?php echo getEmployeeName($rs[0]['fnc_approver']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <br>
