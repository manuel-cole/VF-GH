    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            if (isset($_POST['btnReject'])) {
                ...
                submitAskHRRejection($reqid, $remarks);
            }
            ?>
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <form role="form" name="createuser" action="" method="post">
                            ...
                            <div class="row"><h2>&nbsp;&nbsp;&nbsp;Travel Details</h2>
                                <div class="col-lg-4">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Travel Type</span>
                                        <input type="text" class="form-control" id="purpose" name="purpose"
                                               value="<?php echo getTravelType($rs[0]['request_type']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group input-group">
                            ...
                            <div class="row"><h2>&nbsp;&nbsp;&nbsp;AskHR</h2>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group input-group">
                                        ...
                                        <input type="text" class="form-control" id="acc_cost" name="acc_cost" value=""
                                               required>
                                    </div>
                                </div>
                            </div>
