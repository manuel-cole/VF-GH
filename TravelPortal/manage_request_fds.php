...
$fds_pending = getRequestsFDS($empno);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="user-list">
                                ...
                                <tbody>
                                <?php foreach ($fds_pending as $fds_pending) : ?>
                                    <?php if (!empty($fds_pending)) :
                                        $_counter = $_counter + 1;
                                        $id = $fds_pending['auto_id'];
                                        ?>
                                        <tr>
                                            <td class="user-cell" style="width:20px"><?php echo $_counter; ?></td>
                                            <td class="user-cell"
                                                style="width:180px"><?php echo getEmployeeName($fds_pending['emp_id']); ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $fds_pending['submitted_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $fds_pending['cost_centre']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $fds_pending['destination']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $fds_pending['departure_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $fds_pending['arrival']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo getTravelType($fds_pending['request_type']); ?></td>
                                            <td><a type="button" class="btn btn-primary btn-xs"
                                                   href="process_request_fds?id=<?php echo $id; ?>">Manage</a></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                </tbody>
