...
$usr_pending = getRequestsUser($empno);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="user-list">
                                ...
                                <tbody>
                                <?php foreach ($usr_pending as $usr_pending) : ?>
                                    <?php if (!empty($usr_pending)) :
                                        $_counter = $_counter + 1;
                                        $id = $usr_pending['auto_id'];
                                        ?>
                                        <tr>
                                            <td class="user-cell" style="width:20px"><?php echo $_counter; ?></td>
                                            <td class="user-cell"
                                                style="width:180px"><?php echo getEmployeeName($usr_pending['emp_id']); ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $usr_pending['submitted_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $usr_pending['cost_centre']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $usr_pending['destination']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $usr_pending['departure_date']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo $usr_pending['arrival']; ?></td>
                                            <td class="user-cell"
                                                style="width:120px"><?php echo getRequestStatus($usr_pending['request_status']); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                </tbody>
