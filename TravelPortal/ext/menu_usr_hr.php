...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#">AskHR<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="manage_request_hr">Pending Approval</a></li>
                    <li><a href="manage_request_imp">Pending Implementation</a></li>
                    <li><a href="request_dashboard">Request Dashboard</a></li>
                </ul>
            </li>
            </li>
            <li>
