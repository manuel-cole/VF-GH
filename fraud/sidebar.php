...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse ">
        <ul class="nav" id="side-menu">
            ...
            <?php } ?>
            <li>
                <a href="#"><i class="fa fa-th-list fa-fw"></i>Reports<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="report_invalid.php">Invalid Simreg</a>
                    </li>
                    <li>
                        <a href="#">Roaming</a>
                    </li>
                    <li>
                        <a href="report_clir.php">Clir Request</a>
                    </li>
