                ...
                <div class="panel panel-primary" style="background-color: #dadada">
                    <div class="panel-body">
                        <div class="bs-example">
                            <form class="form-horizontal" action="addAdvanceFeeProcess.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Msisdn :</label>
                                    <div class="col-xs-9">
                                        <input name="msisdn" type="number" class="form-control"  placeholder="Enter MSISDN" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Fraud Type :</label>
                                    <div class="col-xs-9">
                                        <input name="fraudType" type="text" class="form-control" placeholder="Enter Fraud Type" required>
                                    </div>
                                </div>
                                <div class="form-group">
