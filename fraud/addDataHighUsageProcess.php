...
$sql = "INSERT INTO dhu(msisdn,eventDate,remarks,reporter,agent_msisdn) "
    . "VALUE ('$msisdn','$eventDate','$remarks','$fullname','$agentMsisdn')";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <a href="addDataHighUsage.php" class="btn btn-default">Close</a>
                </form>
            </div>
        </div>
    </div>
