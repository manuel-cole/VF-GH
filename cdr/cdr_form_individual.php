...
<!--                            </div>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" class="form-control" type="email" placeholder="Enter an active email address" required>
                                </div>
                            </div>
<!--                            <div class="form-group">-->
...
<!--                            </div>-->
                        ...
                        <div class="panel-footer">
                            <div class="bs-example">
                                <ul class="pager">
                                    <li class="previous"><button name="cmdBtnIndividual" type="button" onclick="myButton()">&larr; Previous</button></li>
                                    <li class="next"><button name="cmdBtnIndividual" type="submit" >Next &rarr;</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
