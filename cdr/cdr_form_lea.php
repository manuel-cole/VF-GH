                    ...
                    <div style="background-color: #ffffff" class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3 tooltipp">Name of Security Agency: <span style="color: red; font-size: 8px" class="glyphicon glyphicon-asterisk"></span></label>
                                <div class="col-xs-9">
                                    <input name="name_of_security_agency" class="form-control" type="text" placeholder="Enter Security Agency Name" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-3 tooltipp">Name of Investigator: <span style="color: red; font-size: 8px" class="glyphicon glyphicon-asterisk"></span></label>
                                <div class="col-xs-9">
                                    <input name="name_of_investigator" class="form-control" type="text" placeholder="Enter Name of Security Officer (Investigator)" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-3 tooltipp">Telephone Number: <span style="color: red; font-size: 8px" class="glyphicon glyphicon-asterisk"></span></label>
                                <div class="col-xs-9">
                                    <input name="telephone_number" class="form-control" type="number" placeholder="Enter Your Number (To Receive Verification Code)" required>
                                </div>
                            </div>
<!--                            <div class="form-group">-->
...
<!--                            </div>-->
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3 tooltipp">Upload Court Order: <span style="color: red; font-size: 8px" class="glyphicon glyphicon-asterisk"></span></label>
                                <div class="col-xs-5">
                                    <input name="order" class="form-control" type="file" accept=".doc,.docx,.pdf,.jpg,.png" required>
                                    <span class="hint"><b>Hint :</b> Upload a docx, pdf, or jpg file under 350 Kb of size.<span class="hint-pointer">&nbsp;</span></span>
                                </div>
                            </div>
<!--                            <div class="form-group">-->
...
<!--                            </div>-->
                        ...
                        <div class="panel-footer">
                            <div class="bs-example">
                                <ul class="pager">
                                    <li class="previous"><button name="cmdBtnLea" type="button" onclick="myButton()">&larr; Previous</button></li>
                                    <li class="next"><button name="cmdBtnLea" type="submit" >Next &rarr;</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
